<script>
  ...
  const CSV_TO_OUTLET_KEY = {
    ...
    'Channel 10': 'OtherGlobal',
    'Channel 7 (Arutz Sheva)': 'OtherGlobal',
    DoctorsOnly: 'OtherGlobal',
    'Erem News': 'OtherGlobal',
    'Haredim 10': 'OtherGlobal',
    'KAN Arabic': 'OtherGlobal',
    Kurdistan24: 'OtherGlobal',
    'The New Arab (UK)': 'OtherGlobal',
    'Radio Tzafon': 'OtherGlobal',
    TimeOut: 'OtherGlobal',
    'Turkish Daily': 'OtherGlobal',
    'Under the Radar': 'OtherGlobal',
    arabi21: 'OtherGlobal',
    i24News: 'OtherGlobal',
  };
