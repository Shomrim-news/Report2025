...
>
  <div class="grid items-end" style="grid-template-columns: 1fr auto 1fr;">
    <div class="flex items-end gap-12.5">
      ...
      {#if isOpen}
        <div class="flex gap-17" in:fade={{ duration: 300, delay: 50 }}>
          <div class="relative flex flex-col items-center">
            ...
            <div class="absolute top-10.75 left-7.75">
              <div class="w-19.5 h-[0.5px] bg-grey-200"></div>
              <div
                class="absolute top-[-2.5px] right-[-2.5px] w-1.25 h-1.25 bg-grey-300 rounded-full"
              ></div>
            </div>
          </div>
          <div class="text-sm leading-lg italic tracking-[2%] max-w-35 mt-6">
    ...
    {#if isOpen}
      <div
        class="legend-description max-w-135 self-start mt-4.5"
